...
#        PROJECT: T-Remix            #
#        Author: MOHD UMAIR          #
#  email: umairsidd8418@gmailcom   #
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO MOHD UMAIR TOOLS  \e[m "
echo
...
echo "
        ...
        WELCOME TO MOHD UMAIR TOOLS_-^^HACKING AND CODING TOOLS^^-_ VISIT ON MY WEBSITE
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY MOHD UMAIR\e[m "
echo -e "\033[1;33m[*]setting termux as a real hacker \e[m"
echo -e "\033[1;33m[*]Please visit on my website https://umairpy.blogspot.com/ for hacking tutorial! \e[m "
echo FINISHED !
echo -e "\033[1;32m                                                             
﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌ \033[m "
sleep 4.0
...
echo -e "\e[32m     
    ...
    visit https://umairpy.blogspot.com/ website for hacking and coding tools,ok?
...
tput cup 6 30
echo -e "\x1b[42m MODH UMAIR's HACKING AND CODING TOOLS website \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you visit on my website https://umairpy.blogspot.com/ for hacking tools (y/n)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m Thankyou for visiting my website \e[m"
else
tput cup 17 23
    echo -e "\x1b[41m Please visit on  my website for hacking tools \x1b[m"
fi
tput cup 20 0
figlet -f slant "MOHD UMAIR's HACKING AND CODING TOOLS" |lolcat
echo " "
echo " "
#done setting up
